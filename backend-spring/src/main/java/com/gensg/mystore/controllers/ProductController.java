...
public class ProductController {
    ...
    public String seed() throws ServletException {
        ...
        products.add(new Products("MEN Jean-Michel Basquiat UT (Short Sleeve Graphic T-Shirt)", "Andy Warhol, Jean-Michel Basquiat, and Keith Haring's iconic works on UT.", "Tshirt", "Jean-Michel Basquiat", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/440879/sub/goods_440879_sub13.jpg?width=1600&impolicy=quality_75", 19.9f, 10,4.5f, 2));
        products.add(new Products("MEN Andy Warhol UT (Short Sleeve Graphic T-Shirt)", "Andy Warhol, Jean-Michel Basquiat, and Keith Haring's iconic works on UT.", "Tshirt", "Andy Warhol", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/440876/sub/goods_440876_sub13.jpg?width=1600&impolicy=quality_75", 19.9f, 10, 5.0f, 2));
        products.add(new Products("MEN Keith Haring UT (Short Sleeve Graphic T-Shirt)", "Andy Warhol, Jean-Michel Basquiat, and Keith Haring's iconic works on UT.", "Tshirt", "Keith Haring", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/440871/sub/goods_440871_sub13.jpg?width=1600&impolicy=quality_75", 19.9f, 10, 5.0f, 3));
        products.add(new Products("MEN Jean-Michel Basquiat UT (Short Sleeve Graphic T-Shirt)", "Andy Warhol, Jean-Michel Basquiat, and Keith Haring's iconic works on UT.", "Tshirt", "Jean-Michel Basquiat", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/440878/sub/goods_440878_sub13.jpg?width=1600&impolicy=quality_75", 29.9f, 10, 0f, 0));
        products.add(new Products("MEN Keith Haring UT (Short Sleeve Graphic T-Shirt)", "Andy Warhol, Jean-Michel Basquiat, and Keith Haring's iconic works on UT.", "Tshirt", "Keith Haring", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/433060/sub/goods_433060_sub13.jpg?width=1600&impolicy=quality_75", 15.9f, 10, 4.0f, 4));
        products.add(new Products("MEN Andy Warhol UT (Short Sleeve Graphic T-Shirt)", "Andy Warhol, Jean-Michel Basquiat, and Keith Haring's iconic works on UT.", "Tshirt", "Andy Warhol", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/440875/sub/goods_440875_sub13.jpg?width=1600&impolicy=quality_75", 19.9f, 10, 4.0f, 6));
        ...
        products.add(new Products("MEN +J Selvedge Slim Fit Straight Jeans", "New Arrival! Jeans made from selvedge denim.", "Jean", "+J", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/446518/sub/goods_446518_sub13.jpg?width=1600&impolicy=quality_75", 99.9f, 10, 0f, 0));
        ...
        products.add(new Products("MEN Selvedge Regular Fit Jeans","Available early Dec", "Jean", "Uniqlo", "https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/447652/item/goods_01_447652.jpg?width=1600&impolicy=quality_75", 59.9f, 10, 0f, 0));
