  ...
  <nav class="flex justify-between bg-gray-900 text-white">
    <div class="px-5 xl:px-12 py-6 flex w-full items-center">
      <a class="text-3xl font-bold font-heading" href="/#/">
        <img class="h-20" src="makito.png" alt="logo">
      </a>
      <!-- Nav Links -->
      <ul class="hidden sm:flex px-4 mx-auto font-semibold font-heading space-x-12">
        <li><a class="hover:text-gray-200" href="/#/">Home</a></li>
        <li><a class="hover:text-gray-200" href="/#/dashboard">Admin</a></li>
        <li><a class="hover:text-gray-200" href="/#/aboutus">About Us</a></li>
      </ul>
      <!-- Header Icons -->
    ...
    <!-- Responsive navbar -->
    <a class="sm:hidden flex mr-6 items-center" href="/#/cart">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
      <!--span class="flex absolute -mt-5 ml-4">
    ...
    <div class="sm:hidden navbar-burger self-center mr-12 " href="#">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
